...
Complete API reference for the hell fire UI system. All UI components are built on Phaser 3 and follow consistent patterns for visibility management, event handling, and resource cleanup.
