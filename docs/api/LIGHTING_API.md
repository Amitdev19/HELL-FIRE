...
Complete API documentation for the hell fire lighting system.
...
The `LightingSystem` provides centralized dynamic lighting management for the hell fire. It uses Phaser's Light2D pipeline with normal maps for realistic lighting effects including:
