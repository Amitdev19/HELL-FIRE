# HELL FIRE - Game Design Document
...
### Genre
**HELL FIRE** is a top-down roguelike hell fire with action-RPG elements, featuring procedurally generated dungeons, permadeath mechanics, and a hub-based world selection system.
...
*This document describes the complete game design for HELL FIRE v1.0*
