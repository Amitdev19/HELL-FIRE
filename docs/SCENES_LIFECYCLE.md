...
This document describes the Phaser scene lifecycle, the BaseScene pattern, scene transitions, data passing, and cleanup requirements in HELL FIRE.
...
The scene system in HELL FIRE follows these principles:
