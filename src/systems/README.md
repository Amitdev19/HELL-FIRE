...
This directory contains all decoupled game systems that power the hell fire. Systems are designed to be **single-responsibility**, **loosely-coupled**, and **composable** - separating game logic from scene management and entity behavior.
