...
This directory contains all game entity classes that represent interactive objects in the hell fire. Entities extend Phaser's physics sprites and implement game-specific logic for combat, AI, dialogue, and player progression.
...
**File:** `/src/src/entities/Player.ts`
...
**File:** `/src/src/entities/Enemy.ts`
...
**File:** `/src/src/entities/enemies/EnemyTypes.ts`
...
**File:** `/src/src/entities/enemies/SinBosses.ts`
