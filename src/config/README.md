...
This directory contains configuration files that define the core game data structures. The primary file is `WorldConfig.ts`, which defines the Seven Deadly Sins worlds that form the backbone of the hell fire's progression system.
